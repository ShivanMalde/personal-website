...
{{< service-card
  ...
  subtitle="Stop crossing your fingers every time you deploy"
...
{{< service-card
  ...
  subtitle="Prove your infrastructure is in a known state - to auditors and yourself"
  badge="Discovery Included"
>}}
...
{{< service-card
  ...
  subtitle="Adopt AI coding tools without introducing security or compliance risk"
  badge="Discovery Included"
>}}
...
{{< timelineItem icon="code" header="Weeks 2-12" badge="Execution & Automation" subheader="Implementation Phase" md="true">}}
